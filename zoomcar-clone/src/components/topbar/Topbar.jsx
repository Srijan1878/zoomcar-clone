...
export default function Topbar() {
    return (
	 ...
	 viewBox="0 0 105 27" style={{enableBackground:"new 0 0 105 27",fill:"#FFFFFF"}} xmlSpace="preserve">
	...
	<g id="XMLID_183_">
		...
		<path id="XMLID_184_" class="st0" d="M97.6,23.5c0.4,0,0.7-0.1,0.9-0.3c0.2-0.2,0.3-0.4,0.4-0.8l0-0.1c-0.1,0.1-0.2,0.1-0.4,0.2
            ...
            <ul className="navListContainer">
                <li className="navListItem">Offers</li>
                <li className="navListItem">Subscription</li>
                <li className="navListItem">Amigo</li>
                <li className="navListItem">ZMS</li>
                <li className="navListItem">Mobile app</li>
                <li className="navListItem">signup</li>
